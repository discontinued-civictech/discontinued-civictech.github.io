...
```
All accepted workshop participants (also virtual participants) have to pay the workshop fee of $238 and a conference ticket (one day ticket only for the workshop day or a full conference ticket). 

Please check the CHI'23 registration pages to find out about the pricing (https://chi2023.acm.org/for-attendees/). 

Please note that early bird rates end on March 13, 2023.
```
